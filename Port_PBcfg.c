...
const Port_ConfigType Port_PinConfig = {
		...
		PORT_PortF , PORT_Pin0, PORT_PIN_IN, OFF, PORT_PIN_LEVEL_LOW , PORT_PIN_MODE_DIO , STD_ON, STD_ON, // button
		PORT_PortF , PORT_Pin1, PORT_PIN_OUT, OFF, PORT_PIN_LEVEL_LOW, PORT_PIN_MODE_DIO , STD_ON, STD_ON, // led
		...
		PORT_PortF , PORT_Pin4, PORT_PIN_IN, PULL_UP, PORT_PIN_LEVEL_LOW,  PORT_PIN_MODE_DIO , STD_ON, STD_ON // button
